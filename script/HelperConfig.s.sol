...
contract HelperConfig is Script {
    ...
    function getEthSepoliaConfig() public pure returns (NetworkConfig memory ethSepoliaNetworkConfig) {
        ethSepoliaNetworkConfig =
            NetworkConfig({entryPoint: 0x5FF137D4b0FDCD49DcA30c7CF57E578a026d2789, account: BURNER_WALLET});
    }

    function getZKsyncSepoliaConfig() public pure returns (NetworkConfig memory ethSepoliaNetworkConfig) {
        ethSepoliaNetworkConfig = NetworkConfig({entryPoint: address(0), account: BURNER_WALLET});
    }
